...
describe('failure tests', function() {
  ...
  it('should throw if no authorization header and credentials are required', function() {
    expressjwt({ secret: 'shhhh', credentialsRequired: true })(
      req,
      res,
      function(err) {
        assert.ok(err);
  ...
  it('support unless skip', function() {
    ...
    expressjwt({ secret: 'shhhh' }).unless({ path: '/index.html' })(
      req,
      res,
      function(err) {
        assert.ok(!err);
  ...
  it('should next if authorization header is not Bearer and credentialsRequired is false', function() {
    req.headers = {};
    req.headers.authorization = 'Basic foobar';
    expressjwt({ secret: 'shhhh', credentialsRequired: false })(
      req,
      res,
      function(err) {
  ...
  it('should throw if audience is not expected', function() {
    ...
    req.headers = {};
    req.headers.authorization = 'Bearer ' + token;
    expressjwt({ secret: 'shhhhhh', audience: 'not-expected-audience' })(
      req,
      res,
      function(err) {
        assert.ok(err);
  ...
  it('should throw if token issuer is wrong', function() {
    ...
    req.headers = {};
    req.headers.authorization = 'Bearer ' + token;
    expressjwt({ secret: 'shhhhhh', issuer: 'http://wrong' })(
      req,
      res,
      function(err) {
        assert.ok(err);
  ...
  it('should throw error if token is expired even with when credentials are not required', function() {
    ...
    req.headers = {};
    req.headers.authorization = 'Bearer ' + token;
    expressjwt({ secret: secret, credentialsRequired: false })(
      req,
      res,
      function(err) {
        assert.ok(err);
  ...
  it('should throw error if token is invalid even with when credentials are not required', function() {
    ...
    req.headers = {};
    req.headers.authorization = 'Bearer ' + token;
    expressjwt({ secret: 'not the secret', credentialsRequired: false })(
      req,
      res,
      function(err) {
        assert.ok(err);
...
describe('work tests', function() {
  ...
  it('should work with nested properties', function() {
    ...
    req.headers = {};
    req.headers.authorization = 'Bearer ' + token;
    expressjwt({ secret: secret, requestProperty: 'auth.token' })(
      req,
      res,
      function() {
  ...
  it('should set resultProperty if option provided', function() {
    ...
    req.headers = {};
    req.headers.authorization = 'Bearer ' + token;
    expressjwt({ secret: secret, resultProperty: 'locals.user' })(
      req,
      res,
      function() {
  ...
  describe('should work when getToken is Promise like function', function() {
    it('getToken is AsyncFunction', function() {
      ...
      expressjwt({ secret: secret, getToken })(req, res, function(err) {
